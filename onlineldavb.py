...
class OnlineLDA:
    ...
    def __init__(self, vocab, K, D, alpha = None, eta = None, tau0 = 1024, kappa = 0.7):
        """
        Arguments:
        K: Number of topics
    ...
    def update_lambda(self, sessions):
        ...
        Arguments:
        sessions:  List of D documents. Each document must be represented
